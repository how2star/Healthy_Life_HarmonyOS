...
import Rdb from "@bundle:com.example.healthy_life/entry/ets/common/database/rdb/UserRdbHelper";
export default class UserInfoApi {
    private accountTable = new Rdb(CommonConstants.USERINFO_TABLE.tableName, CommonConstants.USERINFO_TABLE.sqlCreate, CommonConstants.USERINFO_TABLE.columns);

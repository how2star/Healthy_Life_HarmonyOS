...
interface AchievementSingleDialog_Params {
...
import { AchievementMap, TaskMapById } from "@bundle:com.example.healthy_life/entry/ets/model/TaskInitList";
const ANGLE_LARGE = 360;
export class AchievementSingleDialog extends ViewPU {
    ...
    setInitiallyProvidedValue(params: AchievementSingleDialog_Params) {
    ...
    updateStateVars(params: AchievementSingleDialog_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/AchievementSingleDialog.ets(59:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/view/dialog/AchievementSingleDialog.ets(61:7)", "entry");
            Image.width(Const.THOUSANDTH_560);
            Image.height(Const.THOUSANDTH_400);
            Image.objectFit(ImageFit.Contain);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777332, "type": 10003, params: [this.achievementLevel,
                    getContext(this).resourceManager.getStringSync(TaskMapById[this.taskID - 1].taskName)], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/AchievementSingleDialog.ets(66:7)", "entry");

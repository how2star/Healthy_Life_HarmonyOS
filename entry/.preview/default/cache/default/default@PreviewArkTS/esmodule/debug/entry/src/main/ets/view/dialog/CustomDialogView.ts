...
interface CustomDialogView_Params {
    ...
    // single achievement
    achievementSingleDialog?: CustomDialogController;
    // degree achievement
    achievementDegreeDialog?: CustomDialogController;
    // task clock dialog
...
import { AchievementSingleDialog } from "@bundle:com.example.healthy_life/entry/ets/view/dialog/AchievementSingleDialog";
import { AchievementDegreeDialog } from "@bundle:com.example.healthy_life/entry/ets/view/dialog/AchievementDegreeDialog";
...
export class CustomDialogView extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__taskID = new ObservedPropertySimplePU(0, this, "taskID");
        this.addProvidedVar("taskID", this.__taskID, false);
        ...
        this.achievementDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new AchievementDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/CustomDialogView.ets", line: 42, col: 14 });
        ...
        this.achievementSingleDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new AchievementSingleDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/CustomDialogView.ets", line: 48, col: 14 });
                jsDialog.setController(this.
                // single achievement
                achievementSingleDialog);
                ViewPU.create(jsDialog);
                let paramsLambda = () => {
                    return {};
                };
        ...
        this.achievementDegreeDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new AchievementDegreeDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/CustomDialogView.ets", line: 54, col: 14 });
                jsDialog.setController(this.
                // degree achievement
                achievementDegreeDialog);
                ViewPU.create(jsDialog);
                let paramsLambda = () => {
                    return {};
                };
        ...
        this.taskDialog = new CustomDialogController({
            builder: () => {
                let jsDialog = new TaskDetailDialog(this, {}, undefined, -1, () => { }, { page: "entry/src/main/ets/view/dialog/CustomDialogView.ets", line: 60, col: 14 });
                jsDialog.setController(this.
                // task clock dialog
                taskDialog);
                ViewPU.create(jsDialog);
    ...
    setInitiallyProvidedValue(params: CustomDialogView_Params) {
        ...
        if (params.achievementSingleDialog !== undefined) {
            this.achievementSingleDialog = params.achievementSingleDialog;
        }
        if (params.achievementDegreeDialog !== undefined) {
            this.achievementDegreeDialog = params.achievementDegreeDialog;
        }
    ...
    // single achievement
    private achievementSingleDialog: CustomDialogController;
    // degree achievement
    private achievementDegreeDialog: CustomDialogController;
    // task clock dialog
    ...
    aboutToAppear() {
        ...
        this.broadCast.on(BroadCastType.SHOW_SINGLE_ACHIEVEMENT_DIALOG, (achievementLevel: number, taskID: number) => {
            Logger.debug('CustomDialogView', 'SHOW_SINGLE_ACHIEVEMENT_DIALOG');
            this.achievementLevel = achievementLevel;
            this.taskID = taskID;
            this.achievementSingleDialog.open();
        });
        this.broadCast.on(BroadCastType.SHOW_DEGREE_ACHIEVEMENT_DIALOG, (achievementLevel: number, taskID: number) => {
            Logger.debug('CustomDialogView', 'SHOW_DEGREE_ACHIEVEMENT_DIALOG');
            this.achievementLevel = achievementLevel;
            this.taskID = taskID;
            this.achievementDegreeDialog.open();
        });
        // task clock dialog

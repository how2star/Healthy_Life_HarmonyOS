...
import { CONTINUE_LEVEL_LIST, ContinueMap } from "@bundle:com.example.healthy_life/entry/ets/model/TaskInitList";
import { DEGREE_LEVEL_LIST, DegreeMap } from "@bundle:com.example.healthy_life/entry/ets/model/TaskInitList";
...
function getAchievement(key: string) {
    let result = { "id": 16777235, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" };
    switch (key) {
        case 'off_3':
...
export function getDegreeCardItems(successiveDays: Array<number>): Array<CardInfo> {
